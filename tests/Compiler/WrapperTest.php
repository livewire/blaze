...
test('wraps component templates into function definitions', function () {
    ...
    expect($wrapped)->toEqualCollapsingWhitespace(join('', [
        ...
        'foreach ($__bound as $__key) { if (str_contains($__key, \'-\') && array_key_exists($__key, $__data)) { $__data[\Illuminate\Support\Str::camel($__key)] ??= $__data[$__key]; } } unset($__key); extract($__data, EXTR_SKIP); unset($__data, $__bound); ',
        'ob_start(); ?> ',
        '@blaze ',
