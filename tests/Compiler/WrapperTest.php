...
test('wraps component templates into function definitions', function () {
    ...
    expect($wrapped)->toEqualCollapsingWhitespace(join('', [
        ...
        'foreach ($__data as $__key => $__value) { if (str_contains($__key, \'-\')) { $__data[\Illuminate\Support\Str::camel($__key)] ??= $__value; } } unset($__key, $__value); extract($__data, EXTR_SKIP); unset($__data, $__bound); ',
        'ob_start(); ?> ',
        '@blaze ',
